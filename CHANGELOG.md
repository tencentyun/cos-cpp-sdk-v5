...
## [v5.5.23](https://github.com/tencentyun/cos-cpp-sdk-v5/compare/v5.5.22...v5.5.23) - 2026-09-23

v5.5.23: 新增 HTTP(S) 长连接复用连接池

- 新增 ConnectionPool 连接池, 按 host:port:scheme 分池管理空闲连接,
开启 CosSysConfig::SetKeepAlive(true) 后 HTTP/HTTPS 请求复用连接,
显著减少 TCP/TLS 握手开销
- 支持池容量、空闲超时、最大生命周期配置(ConnectionPoolSize /
ConnectionPoolMaxIdleMs / ConnectionPoolMaxAgeMs), 可经 config.json
或 API 设置; 内建陈旧连接探测、Connection: close 响应隔离、
过期驱逐与低频清扫, 防止复用被污染或已失效的连接
- 功能默认关闭, 不开启 SetKeepAlive 时行为与旧版本完全一致, 可安全升级
- 新增 41 个专项单测(基本对象/分块断点/桶配置/异步接口/连接池逻辑)
验证各接口功能正确且连接被真实复用

### Merged

- Feature zackcao 365e8a28 [`#201`](https://github.com/tencentyun/cos-cpp-sdk-v5/pull/201)

### Commits

- refactor(demo): split cos_demo.cpp into module-based standalone demos [`100d015`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/100d0150631673a0db78ddbecec978c390a15237)
- 优化object_op的单测 [`c9e77a9`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/c9e77a93ae58b567dbc561dc2d5569ae941a9c81)
- feat: 新增 HTTP 长连接复用连接池及专项测试 [`2ea7264`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/2ea72648282bde341bae122c1725acd4e39a4da6)
- feat: 改造分片上传断点续传逻辑，引入本地checkpoint机制 (merge request !72) [`4d59bea`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/4d59bea758c23d4ca5195d32f68637da5e71cc8e)
-  添加单测 [`6a6f674`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/6a6f674ece075107edc0f7b6cdf70f6478ff2bb7)
- 修复用户取消操作后也会自动重试的问题 [`8d1e77d`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/8d1e77d4b5da662c6d9717c02aa72e9782ef5858)
- fix(multiupload): 修复断点续传全量命中时死锁及流读取错误处理 [`5bd5218`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/5bd52185df3e7863cb9bdd5a9bd22404770bd473)
- GetBucket方法新增RestoreStatus和StorageTier字段解析 [`1803d09`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/1803d090d4141fb7ce7e38fe1686ba002f8ba22a)
- Updated CHANGELOG.md [`0644b26`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/0644b263308e846eb843efff08a399b6f109bc9d)
- chore: 升级 SDK 版本至 v5.5.23 [`a2cb30d`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/a2cb30db3ddf1949389634370d7335e365e8a28e)
- 更新 SDK 版本号 [`6fd8f49`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/6fd8f490c7e845b4dc100872531fecceff343a22)

## [v5.5.22](https://github.com/tencentyun/cos-cpp-sdk-v5/compare/v5.5.19...v5.5.22) - 2026-06-11

## What's Changed
* 修复已知问题，移除编译好的三方库文件（提供编译说明） by @lgtczh in https://github.com/tencentyun/cos-cpp-sdk-v5/pull/192
* Feature zackcao f5b76979 by @lgtczh in https://github.com/tencentyun/cos-cpp-sdk-v5/pull/196
* Feature zackcao de07de5f by @lgtczh in https://github.com/tencentyun/cos-cpp-sdk-v5/pull/198
* feat: local checkpoint-based resumable upload + bugfix for deadlock by @lgtczh in https://github.com/tencentyun/cos-cpp-sdk-v5/pull/199


**Full Changelog**: https://github.com/tencentyun/cos-cpp-sdk-v5/compare/v5.5.19...v5.5.22

### Merged

- feat: local checkpoint-based resumable upload + bugfix for deadlock [`#199`](https://github.com/tencentyun/cos-cpp-sdk-v5/pull/199)
- Feature zackcao de07de5f [`#198`](https://github.com/tencentyun/cos-cpp-sdk-v5/pull/198)
...
- Updated CHANGELOG.md [`4962690`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/49626904791c2b0488432be1a5f8cc789453088c)
- Updated CHANGELOG.md [`b273cfe`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/b273cfe57eea0ff7a2a37e428cd28987ee77362e)
- Updated CHANGELOG.md [`fe50e89`](https://github.com/tencentyun/cos-cpp-sdk-v5/commit/fe50e89c882c3f06e31127bd35923dd1ae45344b)
